...
file_list = sorted(Path('/opt/home/thompsonlab/Riboseq_HY/ribominer/ribosome_distribution/RNA/non_miRNA').glob('*.csv'))
...
df_all.to_csv('final_logFC_RNA_nonmiRNA.txt', index = True, sep = '\t', header = True)
