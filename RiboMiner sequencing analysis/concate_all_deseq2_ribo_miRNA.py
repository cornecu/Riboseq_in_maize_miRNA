...
file_list = sorted(Path('/opt/home/thompsonlab/Riboseq_HY/ribominer/ribosome_distribution/Ribo/miRNA').glob('*.csv'))
...
df_all.to_csv('final_logFC_new.txt', index = True, sep = '\t', header = True)
